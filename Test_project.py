...
class QuizApp:
    def __init__(self, root):
        ...
        # MAIN CONTAINER
        self.container = tk.Frame(self.root, bg="#e6f0fa")
        self.container.pack(fill="both", expand=True)

        # SCROLLABLE AREA
        self.canvas = tk.Canvas(self.container, bg="#e6f0fa", highlightthickness=0)
    ...
    def update_scroll_visibility(self):
        ...
        if content_height > window_height:
            ...
            # Hide scrollbar if everything fits perfectly
